 ...
 *    works, through six global tools — memory_save / memory_search /
 *    memory_list / memory_forget / memory_read / memory_write_topic —
 *    into `~/.dsh/memory/projects/<dir>/` (memories.md + topics/*.md).
 * 2. `agent/pre-step` injection of that Markdown as a digest-deduplicated,
 *    log-confirmed `<system-reminder>` (KV-cache friendly), with a
 *    progressive-disclosure index of topic files.
