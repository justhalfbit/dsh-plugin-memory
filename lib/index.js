...
const DEFAULTS = {
  ...
  autoDistill: false,
  memoryDir: '',
  // Sized for a modern context window: 16000 chars is ~0.4% of a 1M-token one
  // and shows ~36 entries, where 4000 could only ever show four.
  injectBudgetChars: 16000,
